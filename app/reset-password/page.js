...
'use client'; // ✅ DEBE estar en la primera línea

import { useState } from 'react';
import { useSearchParams } from 'next/navigation'; // ✅ Importa de 'next/navigation', NO de 'react'
      ...
      {message && (
        <p
          className={`mt-4 text-center text-sm ${
            message.includes('éxito') || message.includes('redirigiendo')
              ? 'text-green-600'
              : 'text-red-600'
          }`}
        >
